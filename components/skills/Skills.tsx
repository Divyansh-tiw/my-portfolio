...
const Skills = ({ skillData }: Props) => {
    ...
    return (
            <SectionWrapper 
            id="skills" 
            className="min-h-screen mt-0 md:mt-0 mx-2 md:mx-0"
            >

            <h2 className="text-4xl text-center">Tech Stack</h2>

            <div className="overflow-x-auto scroll-hide mx-auto mt-6 bg-white dark:bg-grey-800 p-2 flex justify-between items-center gap-3 rounded-md">
